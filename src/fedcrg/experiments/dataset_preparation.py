...
from fedcrg.datasets.eligibility import (
    ClientEligibilityEvaluator,
    EligibilityManifest,
    EligibilityRecord,
)
from fedcrg.datasets.nbaiot import NBaiotAdapter
...
from fedcrg.datasets.preprocessing import (
...
class PrepareDiadFeatureSensitivity:
    ...
    def prepare(
        ...
        from fedcrg.datasets.diad import DiadFeatureSensitivityAdapter
