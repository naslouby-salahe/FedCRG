...
# Matches the float64 serialization convention in fedcrg.evaluation.communication_metrics.
_FLOAT64_BYTES = 8
...
class PreprocessingModel:
    ...
    def constant_features(self) -> tuple[bool, ...]:
        return tuple(
            low == high for low, high in zip(self.global_minima, self.global_maxima, strict=True)
        )
