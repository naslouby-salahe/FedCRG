...
_ALLOWED_SOURCE_LITERALS: dict[tuple[str, object], str] = {
    ...
    ("cli.py", 2): "JSON pretty-print indent width, unrelated to synthetic.gamma_shape",
    ...
    ("evidence/store.py", 2): "JSON pretty-print indent width, unrelated to synthetic.gamma_shape",
    ...
    (
        ...
        4,
    ): "IEEE-754 float32 byte width, unrelated to synthetic.coverage_tolerance_z",
    ("learning/scores.py", 1024): "filesystem hashing chunk size in KiB (IO boundary)",
    ("learning/scores.py", 2): "JSON pretty-print indent width, unrelated to synthetic.gamma_shape",
    ...
    (
        "statistics.py",
        25.0,
    ): "IQR is defined as P75-P25; not a tunable, coincides with statistics.split_sensitivity_percentiles",
    (
        "statistics.py",
        75.0,
    ): "IQR is defined as P75-P25; not a tunable, coincides with statistics.split_sensitivity_percentiles",
