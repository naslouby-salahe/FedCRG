...
def test_policy_registry_is_complete_and_unique() -> None:
    ...
    assert registry.get(PolicyId.ORACLE_TEST).information_regime is InformationRegime.FINAL_TEST_ORACLE
    assert registry.get(PolicyId.SUPERVISED_F1).information_regime is InformationRegime.SUPERVISED_DEVELOPMENT
