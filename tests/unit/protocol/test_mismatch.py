...
def test_exact_mismatch_cutoffs() -> None:
    ...
    cases = [(736, 0, MismatchOutcome.LOW), (736, 1, MismatchOutcome.NO_MATERIAL_DIFFERENCE), (1500, 2, MismatchOutcome.LOW), (1500, 3, MismatchOutcome.NO_MATERIAL_DIFFERENCE), (1500, 32, MismatchOutcome.NO_MATERIAL_DIFFERENCE), (1500, 33, MismatchOutcome.HIGH), (3000, 7, MismatchOutcome.LOW), (3000, 8, MismatchOutcome.NO_MATERIAL_DIFFERENCE), (3000, 58, MismatchOutcome.NO_MATERIAL_DIFFERENCE), (3000, 59, MismatchOutcome.HIGH)]
